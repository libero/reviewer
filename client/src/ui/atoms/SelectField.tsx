...
{
    /*    <button aria-haspopup="listbox" aria-labelledby={`${id}-label ${id}-button`} id={`${id}-button`} />*/
}
{
    /*    <ul id={`${id}-list`} tabIndex={-1} role="listbox" aria-labelledby={`${id}-label`}>*/
}
{
    /*        {values.map(*/
}
