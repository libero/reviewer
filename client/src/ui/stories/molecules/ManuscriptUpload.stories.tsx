...
storiesOf('ui | molecules/ManuscriptUpload', module)
    ...
    .add(
        'With Custom Content',
        (): JSX.Element => {
            const activeContent = text('Active Content', 'Once thy manuscript hath been dragged upon the dropzone, being the manuscript being dragged, thou shall drop it promptly herein.');
            ...
            return (
                <ManuscriptUpload
                    ...
                    inactiveContent={finalInactiveContent}
                />
            )
        }
    )
