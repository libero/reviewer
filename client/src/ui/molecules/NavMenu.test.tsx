...
describe('NavMenu', (): void => {
    ...
    it('should render correct items', (): void => {
        ...
        expect(container.querySelector('.nav-menu__item:first-child .nav-menu__link')).toHaveAttribute(
            'href',
            '/link-1',
        );
        expect(container.querySelector('.nav-menu__item:nth-child(3) .nav-menu__link')).toHaveAttribute(
            'href',
            'www.google.com',
        );
