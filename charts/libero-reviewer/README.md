...
| continuumAdaptor.additionalIngressAnnotations | object | `{}` |  |
...
| submission.additionalIngressAnnotations | object | `{}` |  |
...
| submission.terminationGracePeriodSeconds | int | `120` | Timeout to give long requests a chance to complete before terminating the pod |
